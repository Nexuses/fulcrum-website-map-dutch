...
interface Location {
  ...
  city: string
  country: string
  countryKey: string // English key for map/flag logic
  flag: string
...
const getSelectedCountry = (selectedLocationId: string | null): string | null => {
  ...
  return loc ? loc.countryKey : null
}
            ...
            <div className="flex items-center space-x-3">
              <FlagIcon 
                countryCode={location.countryKey === 'Austria' ? 'AT' : 
                            location.countryKey === 'Germany' ? 'DE' : 
                            location.countryKey === 'United Arab Emirates' ? 'AE' : 
                            location.countryKey === 'Netherlands' ? 'NL' : 'XX'} 
                size="normal"
              />
              <div>
